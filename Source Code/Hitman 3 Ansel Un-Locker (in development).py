...
def main():
    print("Hitman 3 Ansel Un-Locker")
    action = input("Type 'lock' to lock/reset Ansel or 'unlock' to unlock Ansel: ").lower()

    if action == "unlock":
        print("Unlocking Ansel...")
                changes = [
        ...
        print("Invalid input. Please type 'lock' or 'unlock'.")
